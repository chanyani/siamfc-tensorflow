...
def convolutional_alexnet(inputs, is_exemplar, reuse=None, scope='convolutional_alexnet'):
  ...
  with tf.variable_scope(scope, 'convolutional_alexnet', [inputs], reuse=reuse) as sc:
    ...
    with slim.arg_scope([slim.conv2d, slim.max_pool2d],
      ...
      #net = augmented_conv2d(net, 96, (11, 11), (2,2))
      ...
      with tf.variable_scope('conv5'):
        with slim.arg_scope([slim.conv2d],
          ...
          b1 = augmented_conv2d(b1, 128, (3,3),(1,1))
